...
app.get("/mytables", (req, res) => {
  // let user = req.headers.username;
  console.log("ussrr", req.headers.user);
  Tables.find({ user: req.headers.user }, (err, categories) => {
    if (err) return console.log(err);
    let dupa = [];
...
app.delete("/mytables", (req, res) => {
  console.log("USUNIETE", req.headers.name, req.headers.user);
  Tables.findOneAndRemove({ name: req.headers.name }, function (err) {
    if (err) {
      console.log(err);
